...
Newer versions of Visual Studio can now easily manage multiple repos at once. When developing from the [Gemstone.sln](https://github.com/gemstone/root-dev/blob/master/Gemstone.sln) in `root-dev`, it is recommended to use VS 2022 or better.
